...
# WROTE BY Jean-Christophe Duceux.
# THE ORIGINAL BASH SCRIPT CAN BE FOUND ON https://gitlab.com/julianfairfax/scripts/-/blob/main/add-location-to-gnome-weather.sh
# I AM SAVING THIS HERE FOR MY PERSONAL USE FOR WHEN I MAKE A FRESH INSTALL AND WANT TO GET THE WEATHER WORKING FOR MY CITY WHICH ISNT ADDED BY DEFAULT IN THE GNOME WEATHER APP
